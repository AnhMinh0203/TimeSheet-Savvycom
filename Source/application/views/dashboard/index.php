...
<body>
    <div class="test row m-0">
        <?php require(__DIR__ . '\\..\\include\slideBar.html')?>
        <div class=" col-md-10 ">
            <div class="row">
                <div class="col-md-12">
                    <?php require(__DIR__ . '\\..\\include\header.html')?>
                </div>
                <div class=" col-md-8">
    ...
    <script src="/application/views/assets/js/slideBar.js"></script> 
    <script src="/application/views/assets/js/header.js"></script>
</body>
